...
////        target = new QueenDecisionMaker(utils.gold, utils.touchedSite, utils.sites, utils.getAllStructures(), utils.getAllUnits());
...
//    Structure structure7 = new Structure(7,150,4,Constants.MINE, Constants.FRIENDLY_OWNER, 1, 0); // mine
...
//    Site site5 = new Site(5, 500, 900, 30);
//    Site site6 = new Site(6, 600, 900, 30);
//    Site site7 = new Site(7, 700, 900, 30);
//
//    List<Site> sites = Arrays.asList(site1, site2, site3, site4, site5, site6, site7);
//
//    // Units
